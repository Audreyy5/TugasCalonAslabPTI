  ...
  return (
    <div className="App text-center font-serif ">
      <header className="App-header min-h-screen flex flex-col items-center justify-center text-white">
        <h1 className="text-4xl mb-4 mt-12 font-serif text-black italic">Wikipedia Article</h1>
        <p className='font-serif text-black'>Find things that you don't understand here !!</p>
        <form onSubmit={handleSearch} className="mb-8 ">
          <input
            ...
            className="p-2 m-2 text-black text-lg border rounded shadow"
          />
          <button type="submit" className="p-2.5 m-1 text-lg bg-blue-600 text-white rounded hover:bg-blue-800 shadow">
            Cari
          </button>
        </form>
        {loading && <p>Loading...</p>}
